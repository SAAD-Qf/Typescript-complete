...
let gretings = (name : string) => {

    console.log(gretings);
}

// function and function syntex with type annotation and peramiters
...
function my_House(place: string, address: string, postaLcode: number) {
    let my_house = {
        place: place,
        address: address,
...
function performOperation(Add: string, Sub: string, mult: string, div: string) {
    if (Add === "add") {
...
data(  "LARAIB" );
                                                         ...
                                                         // rest perameters
                                                               ...
                                                               // syntex
function car_t(color:string,model:string,brand:string, ...employe:string[]){
...
let car7 = (color:string,height:number,weight:number,brand:string) => {
...
console.log(result);
   ...
   let my = function(a:number,b:number,c:number){         // anonymous function
          return a+b+c
       }
 ...
 if (number <= 0){                              // if we dont provide if condition so we stuck in loop
  ...
  console.log(number);
   ...
   function battery(number:number):void{
   if(number <= 0){
...
function my_call_back(text:string) {
    console.log("my call back function"+text);
}

function call_back(itext:string,call_back:(text:string) => void )
{
    call_back(itext)
}
