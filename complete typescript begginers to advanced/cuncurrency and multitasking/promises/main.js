"use strict";
const start_bike = new Promise((resolve, reject) => {
    setTimeout(() => {
        console.log("start a motorcycle ..... ");
        resolve();
    }, 1000);
});
const shift_1st = new Promise((resolve, reject) => {
    setTimeout(() => {
        console.log("shift to first gear ...... ");
        resolve();
    }, 2000);
});
const shift_2nd = new Promise((resolve, reject) => {
    setTimeout(() => {
        console.log("shift to second gear ...... ");
        resolve();
    }, 3000);
});
const shift_3rd = new Promise((resolve, reject) => {
    setTimeout(() => {
        console.log("shift to third gear ...... ");
        resolve();
    }, 4000);
});
const shift_4th = new Promise((resolve, reject) => {
    setTimeout(() => {
