...
generateTableOfTwo();
let Names = ["saad", "zain", "hasnain", "nehal", "taha", "laraib", "hunain"];
...
party("Laraib", 9);
let merge = { redius: 10 };
let merges = { redius: 25 };
merges = merge;
let mix = { surfece: 10, length: 40 };
let mixed = { surfece: 25 };
mixed = mix;
...
let bike = (model, color, make, brand, owner) => {
    let new_bike = {
        model: model,
        color: color,
        make: make,
